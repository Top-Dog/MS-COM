    ...
    def __init__(self, **kwargs):
        ...
        if kwargs.get('runninginstance'):
            ...
            try:
                ...
                # GetObject(filename) will return a running instance of the file/program (if exists), else starts a new instance
            ...
            if kwargs.get('filename') and self.xlBook is None:
                ...
                try:
                    ...
                    self.xlApp.Windows(self.xlBook.Name).Visible = True # The visibility of the workbook in the instace of excel
                except com_error:
                    # The file does not exist...
                    if self.xlApp:
